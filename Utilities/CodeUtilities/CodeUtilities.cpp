...
int main(int argc, char* argv[])
{
  ...
  std::string conv1 = Converter1<double>::toString(3.1415927);
  std::string conv2 = Converter1<int>::toString(73);
  std::string conv3 = Converter1<std::string>::toString("a_test_string plus more");
  ...
  std::cout << Converter1<double>::toValue(conv1) << ", ";
  std::cout << Converter1<int>::toValue(conv2) << ", ";
  std::cout << Converter1<std::string>::toValue(conv3);
